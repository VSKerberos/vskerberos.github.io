  ...
  class MaterialComponent {
    constructor(firebaseService, spinnerService, dialog) {
      ...
      this.getMaterials = () => {
        ...
        this.firebaseService.getMaterials().subscribe(res => (this.materialList = this.dataSource = res, console.log(res), this.spinnerService.display(false), (0,rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_6__.shareReplay)()));
      };
    }
